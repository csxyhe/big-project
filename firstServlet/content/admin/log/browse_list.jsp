...
<body class="main">
	<form action="${pageContext.request.contextPath}/getBrowse" method="POST">
	...
	<table width="100%">
		<TBODY>
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4" height="26px"><strong>浏&nbsp;&nbsp;览&nbsp;&nbsp;日&nbsp;&nbsp;志</strong></td>
			</tr>
			<tr>
				<td>
					<table cellspacing="0" cellpadding="1" rules="all" bordercolor="green"
						border="1px" id="DataGrid1" style="BORDER-RIGHT:green 1px solid; BORDER-LEFT:green 1px solid;
						 ...
						 <tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
						 	<td align="center" width="13%">用户ID</td>
						 	<td align="center" width="12%">销售ID</td>
						 	<td align="center" width="20%">商品ID</td>
						 	<td align="center" width="20%">开始时间</td>
						 	<td align="center" width="20%">结束时间</td>
						 	<td align="center" width="15%">持续时长（秒）</td>
						 </tr>
						 <c:forEach items="${month_browse}" var="p">
