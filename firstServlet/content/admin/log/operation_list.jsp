...
<body class="main">
	<form action="${pageContext.request.contextPath}/getOperation" method="POST">
	...
	<table width="100%">
		<TBODY>
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4" height="26px"><strong>操&nbsp;&nbsp;作&nbsp;&nbsp;日&nbsp;&nbsp;志</strong></td>
			</tr>
			<tr>
				<td>
					<table cellspacing="0" cellpadding="1" rules="all" bordercolor="green"
						border="1px" id="DataGrid1" style="BORDER-RIGHT:green 1px solid; BORDER-LEFT:green 1px solid;
						 ...
						 <tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
						 	...
						 	<td align="center" width="6%">用户角色</td>
						 	<td align="center" width="9%">操作名称</td>
						 	<td align="center" width="45%">操作内容</td>
						 	<td align="center" width="12%">IP地址</td>
						 	<td align="center" width="13%">操作时间</td>
						 </tr>
						 <c:forEach items="${month_op}" var="p">
						 	<tr onmouseover="this.style.backgroundcolor='white'" onmouseout="this.style.backgroundcolor='#F5FAFE';">
						 		<td style="CURSOR: hand;HEIGHT:22px" align="center" width="15%">${p[0] }</td>
						 		<td style="CURSOR: hand;HEIGHT:22px" align="center" width="6%">${p[1] }</td>
						 		<td style="CURSOR: hand;HEIGHT:22px" align="center" width="9%">${p[2] }</td>
						 		<td style="CURSOR: hand;HEIGHT:22px" align="center" width="45%">${p[3] }</td>
